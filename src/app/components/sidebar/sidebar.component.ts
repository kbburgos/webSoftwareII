...
export const ROUTES: RouteInfo[] = [
  ...
  { path: "/users", title: "Usuarios", class: "", component: "UsersComponent" },
  {
    ...
    title: "Novedades de clientes a repartidores",
    class: "",
    component: "UserNotificationComponent",
  },
  {
    path: "/delivery-notification",
    title: "Novedades de repartidores a clientes",
    class: "",
    component: "DeliveryNotificationComponent",
  },
  {
    path: "/customers",
